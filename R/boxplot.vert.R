                         ...
                         dont.know = "") #gibt es eine "weiß nicht"-Option?
{
  ...
  boxplot(x.aggr,
          ...
          xaxt = "n",
          boxwex = 0.6,
          pars=list(outcol = set.analysis.defaults$color.bars, outpch=20), border = "black",
          ylim = c(0, 100))
  ...
  boxplot(x.aggr,
          ...
          xaxt = "n",
          boxwex = 0.6,
          pars=list(outcol = set.analysis.defaults$color.bars, outpch=20), add = TRUE, border = "black",
          ylim = c(0, 100))
