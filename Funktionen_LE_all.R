                              ...
                              kennung) #  Kennungen
{
  ...
  print(table.stat.single(x, col1.name = "N\\textsubscript{courses}"))
  cat("  \n  \n")
...
{ 
  ...
  mtext(nums, side=4, line=1, at=1:d, las=1, col= color.font, cex=0.8)
  ...
  mtext("Anzahl Veranstaltungen", side=4, line=3, col= color.font, font = 2)
