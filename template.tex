...
% blau-grau (Schiefer)
\definecolor{bluegray}{HTML}{507289}             % RPTU-Farbe (Schiefer)
\definecolor{bluegraytable}{HTML}{EFF2F4}       % RPTU-Farbe-Tabelle (Schiefer)
% grün-grau
\definecolor{greengray}{HTML}{77b6ba}             % RPTU-Farbe (Ozean)
\definecolor{greengraytable}{HTML}{F3F8F9}       % RPTU-Farbe-Tabelle (Ozean)
% dunkelblau
\definecolor{darkblue}{HTML}{042c58}             % RPTU-Farbe (Nacht)
\definecolor{darkbluetable}{HTML}{9AA8AE}       % RPTU-Farbe-Tabelle (Nacht)
