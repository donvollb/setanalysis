...
\definecolor{rptu}{RGB}{80, 114, 137}             % RPTU-Farbe (blaugrau/Schiefer)
...
\renewcommand{\headrule}{\hbox to\headwidth{%
    \color{rptu}\leaders\hrule height \headrulewidth\hfill}}
    
\renewcommand{\footrulewidth}{1pt}
\renewcommand{\footrule}{\hbox to\headwidth{%
    \color{rptu}\leaders\hrule height \footrulewidth\hfill}}
