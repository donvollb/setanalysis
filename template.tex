...
\setmainfont[
Path = rmd-data/RedHatText/ ,          % Pfad, wo Schrifart liegt
UprightFont = RedHatText-Regular,      % Dateiname reguläre Schrift
BoldFont = RedHatText-Bold ,           % Dateiname fette Schrift
ItalicFont = RedHatText-LightItalic ,  % Dateiname kursive Schrift
Extension = .ttf]{RedHatText}          % Dateiendungen
...
% blau-grau (Schiefer)
\definecolor{rptu_blue-gray}{HTML}{507289}             % RPTU-Farbe (Schiefer)
\definecolor{rptu_blue-gray_table}{HTML}{dfe6ea}       % RPTU-Farbe-Tabelle (Schiefer)
% grün-grau
\definecolor{rptu_green-gray}{HTML}{77b6ba}             % RPTU-Farbe (Ozean)
\definecolor{rptu_green-gray_table}{HTML}{e6f2f3}       % RPTU-Farbe-Tabelle (Ozean)
% dunkelblau
\definecolor{rptu_darkblue}{HTML}{042c58}             % RPTU-Farbe (Nacht)
\definecolor{rptu_darkblue_table}{HTML}{D2D9E1}       % RPTU-Farbe-Tabelle (Nacht)

\definecolor{uniblau}{RGB}{7, 63, 139}            % Altes "uniblau" über RGB (Koblenz-Landau)
...
\colorlet{maincolor}{rptu_blue-gray}
\colorlet{tablecolor}{rptu_blue-gray_table}       

$if(color)$
\colorlet{maincolor}{$color$}
\colorlet{tablecolor}{$color$}  
$endif$
...
\lhead{\includegraphics[height=0.7cm]{rmd-data/RPTU_Logo.png}}
\rhead{\includegraphics[height=1.2cm]{rmd-data/meze-logo.png}}
