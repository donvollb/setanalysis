...
% hellgrün (Apfel)
\definecolor{darkgreen}{HTML}{26d07c}             
\definecolor{darkgreentable}{HTML}{EBFBF3} 

% violett (Pflaume)
\definecolor{darkgreen}{HTML}{4c3575}             
\definecolor{darkgreentable}{HTML}{#EFEDF3} 

% pink (Fuchsia)
\definecolor{darkgreen}{HTML}{d13896}             
\definecolor{darkgreentable}{HTML}{FBEDF6} 

% rot (Himbeere)
\definecolor{darkgreen}{HTML}{e31b4c}             
\definecolor{darkgreentable}{HTML}{FCEAEF} 

% orange (Mango)
\definecolor{darkgreen}{HTML}{ffa252}             
\definecolor{darkgreentable}{HTML}{FFF7EF} 
